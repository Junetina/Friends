		...
		<uni-popup type='bottom' ref='popup'>
			<view class='bg-white flex flex-column'>
				...
				<view class='flex align-center'>
					<view class='flex-1 justify-center flex flex-column align-center justify-center py-2'
				...
				<view class='text-center py-2 font-md border-top bg-light-secondary'
...
<script>
	...
	export default {
		...
		//onload生命周期是页面生命周期，在组件里不能使用，需要使用mounted这个生命周期=>页面渲染完成时
		mounted() {
			uni.getProvider({
				service: 'share',
				success: (e) => {
