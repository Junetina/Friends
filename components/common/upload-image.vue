		...
		<view class="uni-common-mt">
						<view class="uni-uploader" v-if='show'>
							<view class="uni-uploader-head">
								...
								<view class="uni-uploader-info rounded">{{imageList.length}}/9</view>
							</view>
								...
								<view class="uni-uploader__files">
									<block v-for="(image,index) in imageList" :key="index">
										<view class="uni-uploader__file position-relative">
											...
											<!-- 添加删除按钮 -->
											<view class='rounded px-2 flex justify-center align-center position-absolute top-0 right-0'
														@click='deleteImage(index)'
														style='background-color: rgba(0,0,0,.5);'>
												<text class='iconfont text-white font icon-shanchu'></text>
											</view>
										</view>
