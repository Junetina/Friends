<template>
	<view>
		...
		<uni-list-item title="浏览历史" showExtraIcon='true'>
			<text slot='icon' class='iconfont icon-liulan font-lg font-weight-bold'></text>
		</uni-list-item>
		<uni-list-item title="社区认证" showExtraIcon='true'>
			<text slot='icon' class='iconfont icon-huiyuanvip font-lg'></text>
		</uni-list-item>
		<uni-list-item title="网络帖子" showExtraIcon='true'>
			<text slot='icon' class='iconfont icon-keyboard font-lg font-weight-bold'></text>
		</uni-list-item>
	</view>
</template>
